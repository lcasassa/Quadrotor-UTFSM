...
void estabilizador_loop(u16 angle_x, u16 angle_y) {
	...
	PWM7 = (u32)(estabilizador[0].ganancia*( angle[0]*20 - angle[1]*20) + 1500*2 + angle_x + estabilizador[0].offset);
	PWM8 = (u32)(estabilizador[1].ganancia*( angle[0]*20 + angle[1]*20) + 1500*2 + angle_y + estabilizador[1].offset);
}
